      ...
      <div className='container services_container'>
        ...
        <article className='service'>
          ...
          <ul className='service_list'>
            <li>
              <BiCheck className='service_list-icon' />
              <a href='https://venkateshportfolionairobi.netlify.app/'target='_blank' rel="noopener"  >  <p>Portfolio</p></a>
            
            </li>
            <li>
              <BiCheck className='service_list-icon' />
              <a href='https://venkatesh-react-crud.netlify.app/' target='_blank' rel="noopener" >  <p>crud</p></a>
